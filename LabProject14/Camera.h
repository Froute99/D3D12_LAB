...
public:
	...
	virtual void SetViewportAndScissorRects(ID3D12GraphicsCommandList* pd3dCommandList);
	...
	// 카메라의 이동, 회전에 따라 카메라의 정보르르 갱신하는 가상함수이다.
...
public:
	...
	virtual void Rotate(float fPtich = 0.0f, float fYaw = 0.0f, float fRoll = 0.0f);
};
